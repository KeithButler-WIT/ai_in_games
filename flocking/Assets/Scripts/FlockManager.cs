...
public class FlockManager : MonoBehaviour {
    ...
    void Start() {
        ...
        int goal = Random.Range(0, goalLocations.Length);
        ...
        FM = this;
        goalPos = goalLocations[goal].transform.position;
    }
    ...
    void Update() {
        ...
        if (Random.Range(0, 100) < 10) {
            ...
            goalPos = goalLocations[Random.Range(0, goalLocations.Length)].transform.position + new Vector3(
                Random.Range(-swimLimits.x, swimLimits.x),
                Random.Range(-swimLimits.y, swimLimits.y),
                Random.Range(-swimLimits.z, swimLimits.z));
        }
